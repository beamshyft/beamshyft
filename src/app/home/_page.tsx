        ...
        <div className="bg-transparent max-w-[1200px] pt-20 relative overflow-hidden">
          ...
          <InfoSection
            ...
            description={
              ...
              <span className="font-bold text-2xl">Our Boston-based startup</span> leverages state-of-the-art factories across multiple continents to eliminate multiple middlemen and supply high-quality materials for the best prices available, guaranteed.
              </span>
              </>
            }
            height="400px"
